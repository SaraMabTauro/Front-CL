...
class _AnalysisDetailScreenState extends State<AnalysisDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Análisis para ${analysis.nombrePareja}'),
  ...
  Widget _buildAnalysisResults(BuildContext context, CoupleAnalysis result, Map<String, String> analysisTypes) {
    return Card(
      elevation: 3,
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        analysisTypes[result.nombrePareja] ?? 'Análisis',
                        style: const TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF20263F),
                      ...
                      Text(
                        'Riesgo de Ruptura: ${(result.prediccionRiesgoRuptura * 100).toInt()}%',
                        style: TextStyle(
                          color: Colors.grey.shade600,
                          fontSize: 14,
                        ),
            ...
            ...result.insightsRecientes.map((insight) => Padding(
            ...
            const SizedBox(height: 12),
            ...result..map((recommendation) => Padding(
              padding: const EdgeInsets.only(bottom: 8),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [

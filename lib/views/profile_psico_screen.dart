...
//   @override
//   _PsychologistProfileViewState createState() => _PsychologistProfileViewState();
// }
...
//     if (psychologist == null) {
//         // Manejar el caso improbable de que el psicólogo sea nulo
...
//           if (psychologist == null) {
//             return const Center(child: Text('No se pudieron cargar los datos del psicólogo.'));
//           }
...
//                         CircleAvatar(
//                           radius: 60,
//                           backgroundColor: const Color(0xFF595082).withOpacity(0.1),
//                           // CORRECIÓN: Lógica de imagen simplificada y segura
//                           backgroundImage: _selectedImage != null
//                               ? FileImage(_selectedImage!) as ImageProvider
//                               : (psychologist.fotoPerfilUrl != null && psychologist.fotoPerfilUrl!.isNotEmpty)
//                                   ? NetworkImage(psychologist.fotoPerfilUrl!)
//                                   : null,
//                           child: (_selectedImage == null && (psychologist.fotoPerfilUrl == null || psychologist.fotoPerfilUrl!.isEmpty))
//                               ? const Icon(Icons.person, size: 60, color: Color(0xFF595082))
//                               : null,
//                         ),
//                         if (_isEditing)
//                           Positioned(
...
//                   // ... (resto de los widgets de texto no necesitan cambios)
//                   Row(
//                     children: [
//                       Expanded(
...
//                     enabled: _isEditing,
//                     validator: (value) => (value == null || value.isEmpty) ? 'La especialidad es requerida' : null,
//                   ),
//                   const SizedBox(height: 16),
...
//                     icon: Icons.badge,
//                     enabled: _isEditing,
//                     validator: (value) => (value == null || value.isEmpty) ? 'La cédula es requerida' : null,
//                   ),
//                   const SizedBox(height: 16),
                  
//                   // CORRECIÓN: Usar el objeto 'psychologist' del controlador
//                    if (psychologist.fechaCreacion != null) ...[
//                       _buildInfoCard('Fecha de Registro', DateFormat('dd/MM/yyyy').format(psychologist.fechaCreacion!)),

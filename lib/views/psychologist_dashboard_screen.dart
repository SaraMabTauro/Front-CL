...
//                   child: Text(
//                     psychController.currentPsychologist?.nombre.substring(0, 1) ?? 'P',
...
//                     Navigator.of(context).pushReplacementNamed('/psychologist-login');
//                   }
//                 },
//                 itemBuilder: (context) => [
//                   PopupMenuItem(
...
//                         Text(psychController.currentPsychologist?.nombre ?? 'Psicólogo'),
//                       ],
//                     ),
//                   ),
//                   const PopupMenuItem(
...
//         final activeCouples = couples.where((c) => c.estado == CoupleStatus.activa).length;
//         final pendingCouples = couples.where((c) => c.estado == CoupleStatus.pendienteAprobacion).length;
...
//                           Text(
//                             controller.currentPsychologist?.especialidad ?? 'Especialista en Terapia de Pareja',
//                             style: const TextStyle(
//                               fontSize: 16,
...
//               ...couples.take(3).map((couple) => _CoupleCard(couple: couple)),
//             ],
//           ),
//         );
//       },
...
//             if (couple.correoCliente1 != null || couple.correoCliente2 != null) ...[
//               Row(
//                 children: [
...
//                 ElevatedButton.icon(
//                   onPressed: () {
//                     Navigator.of(context).pushNamed('/couple-analysis', arguments: couple.id);
//                   },
...
//     final objetivosController = TextEditingController(text: couple.objetivosTerapia);
...
//                     color: analysis.promedioSentimientoIndividual > 0.5 ? Colors.green : Colors.red,
//                   ),
//                 ),
//                 Expanded(
//                   child: _MetricItem(
...
//                     color: analysis.empatiaGapScore > 0.6 ? Colors.green : Colors.orange,
//                   ),
//                 ),
//                 Expanded(
//                   child: _MetricItem(
//                     title: 'Balance',
//                     value: '${(analysis.interaccionBalanceRatio * 100).toInt()}%',
//                     color: analysis.interaccionBalanceRatio > 0.6 ? Colors.green : Colors.red,
//                   ),
//                 ),
//                 Expanded(
//                   child: _MetricItem(
...
//                     color: analysis.recuentoDeteccionCicloNegativo < 3 ? Colors.green : Colors.red,
//                   ),
//                 ),
//               ],
//             ),
...
//               ),
//               const SizedBox(height: 12),
//               ...analysis.insightsRecientes.map((insight) => Padding(
